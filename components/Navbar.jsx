...
const Navbar = () => {
  return (
    <nav className="  bg-(--nav-bg)  fixed top-6 left-0 right-0 z-50 backdrop-blur-md shadow-sm rounded-full h-16 md:max-w-6xl max-w-[350px]  w-full mx-auto flex justify-between items-center px-6 border border-neutral-200 ">
...
{/* logo */}
      <div className=" flex  items-center gap-3 ">
        ...
        {/* logo-text */}
        <span className="  font-light  tracking-tight hidden md:block text-lg ">Yellow Glow Studios</span>
      </div>
