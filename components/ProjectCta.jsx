...
<div className="max-w-4xl mx-auto px-6 text-center">
    ...
    <Link className='group inline-flex  items-center gap-3 bg-neutral-900 text-neutral-50 px-8 py-4 rounded-sm hover:bg-black transition-all duration-300 hover:-translate-y-1 shadow-sm hover:shadow-xl ' href={"mailto:yellowglowstudios@gmail.com"}>
