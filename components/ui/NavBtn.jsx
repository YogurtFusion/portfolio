...
const NavBtn = () => {
  return (
    <a
      ...
      className="group relative inline-flex items-center uppercase rounded-full  bg-neutral-900 text-neutral-50 px-5 py-2.5  text-xs font-medium tracking-wide transition-all duration-300 ease-out hover:translate-y-[-1px] hover:shadow-md active:translate-y-0  w-fit md:w-full"
    >
